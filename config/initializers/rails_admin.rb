# RailsAdmin config file. Generated on September 17, 2013 12:20
...
#  config.current_user_method { current_user } # auto-generated
  ...
  # config.excluded_models = ['Cart', 'LineItem', 'Order', 'Product', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Cart', 'LineItem', 'Order', 'Product', 'User']
  ...
  #     configure :photo_updated_at, :datetime
  ...
  #    session[:user_id] = request.url
      redirect_to main_app.login_url, :alert => "You must first log in or sign up before accessing this page."
    end
  }

  config.authorize_with{
    unless User.find_by_id(session[:user_id]).admin
      redirect_to main_app.admin_path , :alert => "You are not authorized to access that page"
    end
  }
end
